...
a = readFile("../tests/A.txt")
c = readFile("../tests/C.txt")
e = readFile("../tests/E.txt")
h = readFile("../tests/H.txt")
n = readFile("../tests/N.txt")
t = readFile("../tests/T.txt")

print "A.txt"
print match(a, weightMatrix)

print "C.txt"
print match(c, weightMatrix)

print "E.txt"
print match(e, weightMatrix)

print "H.txt"
print match(h, weightMatrix)

print "N.txt"
print match(n, weightMatrix)

print "T.txt"
print match(t, weightMatrix)
